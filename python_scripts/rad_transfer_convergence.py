...
# bin
alphas_norad_bin_wav, alphas_norad_bin, _ = generate_binned_alphas(alphas_norad,
                                                                   [np.ones(alphas_norad[0].shape) for i in
                                                                    range(len(alphas_norad))],
...
ax2.plot(wav_clipped, south_fn(wav_clipped) - wd_fns[3](wav_clipped) * scale_factors_wd_south[3], colors[4],
         label='south - wd (combo)',
         drawstyle='steps-mid')
